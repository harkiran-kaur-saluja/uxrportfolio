            ...
            <nav id="examples">
                <div className="nav-sig">
                    <p className="signature">
                        <img src="img/general/signaturepic.png" alt="Harkiran in signature style"></img>
                    </p>
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col colCheckout">
                        {/*<button className="button" onClick={() => { props.handleClick() }} >SEE ALL WORK< /button> */} </div>
                </div>
            </div>
        ...
        if (project.ProjectNumber % 2 === 1) {
            return (
                <div key={
                    ...
                    <ProjectOverviewLeft project={project}
                        handleClickIndv={
                            props.handleClickIndv
                        }/>
                    <br/><br/>
            ...
            return (
                <div key={
                    ...
                    <ProjectOverviewRight project={project}
                        handleClickIndv={
                            props.handleClickIndv
                        }/>
                    <br/><br/>
            ...
            <div className="row justify-content-center">
                <div className="col col-image">
                    <img src={
                        ...
                        className="height"
                        alt="a banner for humaneOS"/> {/* <div className="image-stack">
                ...
                <div className="col col-content">
                    <div className="fs-2 num">
                        {
                        '0' + props.project.ProjectNumber
                    }</div>
                    <br/>
                    <div className="h2">
                        {
                    ...
                    <div className="h5">
                        {
                        'Role: ' + props.project.ProjectRole
                    }</div>
                    <br/>
                    <div className="lead">
                        {
                    ...
                    <button type="button" className=" btn btn-outline-secondary button"
                        onClick={
                            () => {
                                props.handleClickIndv(props.project)
                            }
                    }>View Project</button>
                    <br/>
                </div>
                ...
                <div class="container">
                    <div className="col">
                        ...
                        <p className="footer_email">I'm always looking to learn from you!
                            <br/>
                            Feel free to reach out at<span> </span>
