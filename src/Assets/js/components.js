    ...
    return (
        <div>
            <div className="aboutText">
                ...
                <img className="kerryPic animate__animated animate__pulse" src="./img/general/pophealthpic.jpg" alt="Harkiran in a pink sweatshirt sitting in front of the Kerry Park view" />
                <br />
