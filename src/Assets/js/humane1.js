    ...
    return (
        <div>
            ...
            <div className="px-5">
                ...
                <img className="img-fluid" src="img/humaneOS/HumaneOS_banner.png" alt="a banner for humaneOS"/>
                
                <h4 class="display">project description</h4>
                <div class="px-5 container-fluid">
                    <div class="row border border-success align-middle">
                        <div class="role col align-middle">
                        ...
                        <div class="role col align-middle">
                            ...
                            <br/>
                            <p>Figma, ideation, wireframing, prototyping, communication and presentation, agile</p>
                        </div>
                        <div class="role col align-middle">
