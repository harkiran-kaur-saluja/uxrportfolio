    ...
    return (
        <div>
            ...
            <div className="px-5 content">
                ...
                <p>After looking at the current version of the <strong className = "bolded-words">health</strong> app on iOS, we notices the colors were the same and there were no symbols, visualizations, or graphs. We wanted to present the information in a clear and meaningful way and provide personal validation. Based on this goal, we created a basic version of a health app. (both whiteboard ideation and higher fidelity concept shown below): </p>
