...
export function HumaneOS (props) {
    ...
    return (
        <div>
            ...
            <div className="px-5 content">
                <p>Our goal for this sprint was to create the design language for our new mobile operating system. We wanted to create something entirely new, and not based off of iOS and/or Android. As we began brainstorming our mobile design language principles, we started to ask ourselves: <strong className = "bolded-words">What is it? and often more importantly, what isn't it?</strong></p>
            ...
            <div className="px-5 content">
                ...
                <p>After looking at the current version of the <strong className = "bolded-words">health</strong> app on iOS, we notices the colors were the same and there were no symbols, visualizations, or graphs. We wanted to present the information in a clear and meaningful way and providegit  personal validation. Based on this goal, we created a basic version of a health app. (both whiteboard ideation and higher fidelity concept shown below): </p>
            ...
            <div className="px-5 content">
                ...
                <p>Starting off with the <strong className = "bolded-words">styleguide</strong>, we wanted fonts and icons that ware readable (legible, good contrast with the background), would add to the visual aspects of the design, and give a more modern feel to users. This is why we decided to go with the sans-serif font <strong className = "bolded-words">Helvetica Now</strong> and have <strong className = "bolded-words">material design icons</strong> (see below).</p>
                <img className="px-5 center-img img-fluid" src="img/humaneOS/styleguide1.png" alt="styleguide with fonts and icons"/>
                <p>The tagging/folder circles from the previous sprint helped us improve the <strong className = "bolded-words">readability</strong> of our apps (see below). We wanted bright and vibrant colors, but not to the point where they would be too off-putting to users.</p>
                ...
                <ul>
                    ...
                    <li>Utility: Wallet, Phone, Clock, Camera, Calculator, Browser</li>
