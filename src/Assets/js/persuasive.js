    ...
    return (
        <div>
            <div className="px-5">
                ...
                <img className="center-img img-fluid" style={{ width: 60 + '%'}} src="img/persuasive/balance_cover_picture.png" alt="the cover for Balance" />
            ...
            <div className="px-5">
                ...
                <h4><u>literature review</u></h4>
                <p>To start off, we conducted a <strong className="bolded-words">literature review</strong> of eleven academic papers that spanned topics relating to taking breaks, stress, self-esteem, workaholism, health, and screen time. Here are some findings from this process:</p>
                <ul>
                ...
                <img className="center-img img-fluid" style={{ width: 50 + '%'}} src="img/persuasive/balance_affinity_analysis.jpg" alt="sticky notes" />
                ...
                <img className="px-5 center-img img-fluid" style={{ width: 50 + '%'}}src="img/persuasive/balance_slide.png" alt="metaphors" />
                <h4>key findings:</h4>
                <ul>
                ...
                <h4>pain points:</h4>
                <p>The most common pain points reported by the university students were connected: <strong className="bolded-words">time management, school-life balance, and stress</strong>.</p>
                ...
                <img className="center-img img-fluid" style={{ width: 50 + '%'}} src="img/persuasive/balance_post_its_2.png" alt="feature sticky notes" />
                ...
                <h4><u>medium-fidelity prototyping</u></h4>
                ...
                <img className="center-img img-fluid" style={{ width: 500}} src="img/persuasive/balance_feedback_2.jpg" alt="feedback notes" />
                <img className=" center-img img-fluid" style={{ width: 500}} src="img/persuasive/balance_feedback_3.jpg" alt="feedback notes" />
                ...
                <h4><u>high-fidelity prototyping</u></h4>
                ...
                <img className="center-img img-fluid" style={{ width: 50 + '%'}} src="img/persuasive/balance_hi_fi_1.png" alt="high-fidelity protptypes" />
                <img className="center-img img-fluid" style={{ width: 50 + '%'}} src="img/persuasive/balance_hi_fi_2.png" alt="high-fidelity protptypes" />
                <img className="center-img img-fluid" style={{ width: 50 + '%'}} src="img/persuasive/balance_hi_fi_3.png" alt="high-fidelity protptypes" />
