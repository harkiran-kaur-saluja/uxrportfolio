        ...
        <div>
            <div className="px-5">
                <h2 className="animate__animated animate__flipInX">
                    <span className="firstName">balance.</span>
                </h2>
                <img className="center-img img-fluid"
                    style={
                        {
                            width: 60 + '%'
                        }
                    }
                    src="img/persuasive/balance_cover_picture.png"
                    alt="the cover for Balance"/>
            ...
            <div className="px-5">
                ...
                <ul>
                    <li>
                        <strong>my role</strong>: UX Researcher + Designer</li>
                    <li>
                        <strong>skills</strong>
                        <strong>used</strong>: semi-structured interviews, focus groups, literature review, remote research, usability testing, prototyping, Figma</li>
                    <li>
                        <strong>project length</strong>: 3 months</li>
                    <li>
                        <strong>team size</strong>: 6 members</li>
                </ul>


                <h4>executive summary
                </h4>
                <blockquote className="px-5">"Ugh, I have so much work to do. I'm so stressed out and I never seem to catch a break from all of these assignments."</blockquote>
                ...
                <p>To start off, we conducted a
                    <strong className="bolded-words">literature review</strong>
                    of eleven academic papers that spanned topics relating to taking breaks, stress, self-esteem, workaholism, health, and screen time. Here are some findings from this process:</p>
                <ul>
                ...
                <h4>focus group and user interviews</h4>
                <h4>
                    <u>focus group</u>
                </h4>
                <p>We conducted a 30-minute
                    <strong className="bolded-words">virtual focus group</strong>
                    with 12 members of our target population, college students. In our session, we used an activity designed to reveal people&rsquo;s perspectives – their thoughts, feelings, needs, wishes, etc. – using metaphors. This activity was called
                ...
                <p>writing down our individual ideas on sticky notes for a few minutes and then putting them all on a common whiteboard (see below). After this, we grouped them into the 5 main categories that we defined as our concepts and send each of our participants a consent form along with the
                    <a href="https://docs.google.com/presentation/d/1mQ-AW05mK92LIsKqA62JnGVi8sI3vEDQqBIGfLRiqbE/edit">New Metaphors slides,</a>
                    where they were instructed to identify up to 5 metaphors that resonated the most with how they think about or experience the concept in question.</p>
                <img className="center-img img-fluid"
                    style={
                        {
                            width: 50 + '%'
                    ...
                    src="img/persuasive/balance_affinity_analysis.jpg"
                    alt="sticky notes"/>
                ...
                <img className="px-5 center-img img-fluid"
                    style={
                        {
                            width: 50 + '%'
                        }
                    }
                    src="img/persuasive/balance_slide.png"
                    alt="metaphors"/>
                <h4>key findings:</h4>
                <ul>
                ...
                <h4>how this impacts the design of our solution:</h4>
                <ul>
                ...
                <p>We thought it might be beneficial to
                    <strong className="bolded-words">hit refresh and reframe</strong>
                    the way we're currently thinking about our project. Instead of encouraging people to take breaks, why not help them break out of this &ldquo;workaholism?&rdquo; This might help us bring in richer research insights and ultimately design something completely new!</p>
                ...
                <img className="center-img img-fluid" src="img/persuasive/balance_table_1.png" alt="questions and rationale"/>
                <img className="center-img img-fluid" src="img/persuasive/balance_table_2.png" alt="questions and rationale"/>
                <h4>pain points:</h4>
                <p>The most common pain points reported by the university students were connected:
                    <strong className="bolded-words">time management, school-life balance, and stress</strong>.</p>
                ...
                <img className="center-img img-fluid"
                    ...
                    src="img/persuasive/balance_low_fi_1.png"
                ...
                <img className="center-img img-fluid"
                    ...
                    src="img/persuasive/balance_low_fi_2.png"
                    alt="low-fidelity prototypes"/>
                <img className="center-img img-fluid"
                    style={
                        {
                    ...
                    src="img/persuasive/balance_low_fi_3.png"
                    alt="low-fidelity prototypes"/>
                ...
                <img className="center-img img-fluid"
                    ...
                    src="img/persuasive/balance_post_its_2.png"
                    alt="feature sticky notes"/>
                ...
                <h4>
                    <u>medium-fidelity prototyping</u>
                </h4>
                <p>Building off the insights we gained from the initial stages of the prototyping process, we designed a medium-fidelity
                    <a href="https://www.figma.com/file/Rdwja8WQicq4nvun7Em7og/Persuasive-Design--Breakthru.?node-id=0%3A1">Figma prototype</a>
                    (video walkthrough
                    <a href="https://youtu.be/Y2PCmTmz0B8">here</a>) to set the foundation for the UI/UX of our app. We completed testing with three users, and our notes from the sessions are shown below:</p>
                <img className="center-img img-fluid" src="img/persuasive/balance_feedback.png" alt="feedback notes"/>
                <img className="center-img img-fluid"
                    style={
                        {width: 500}
                    }
                    src="img/persuasive/balance_feedback_2.jpg"
                    alt="feedback notes"/>
                <img className=" center-img img-fluid"
                    style={
                        {width: 500}
                    }
                    src="img/persuasive/balance_feedback_3.jpg"
                    alt="feedback notes"/>
                ...
                <h4>
                    <u>high-fidelity prototyping</u>
                </h4>
                <p>This stage of the design process enabled us to not only take into account how we were going to specifically implement the persuasive techniques of self-affirmation and social proof, but it also helped us structure the idea of having dares/challenges and allowed us to create a more visually appealing UI. We tested our
                    <a href="https://www.figma.com/proto/Rdwja8WQicq4nvun7Em7og/Persuasive-Design--balance?page-%5b&hellip;%5d48%2C0.08&amp;scaling=scale-down&amp;starting-point-node-id=136%3A1150">high-fidelity prototype</a>
                    with
                ...
                <img className="center-img img-fluid"
                    ...
                    src="img/persuasive/balance_hi_fi_1.png"
                    alt="high-fidelity protptypes"/>
                <img className="center-img img-fluid"
                    style={
                        {
                            width: 50 + '%'
                    ...
                    src="img/persuasive/balance_hi_fi_2.png"
                    alt="high-fidelity protptypes"/>
                <img className="center-img img-fluid"
                    style={
                        {
                    ...
                    src="img/persuasive/balance_hi_fi_3.png"
                    alt="high-fidelity protptypes"/>
