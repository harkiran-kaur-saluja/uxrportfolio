            ...
            <div className='container'>
                <div className='row'>
                    <div className="col br">
                        <h3 className='highlight'><mark>I researched ways to help college students find the balance between work and play.</mark></h3>
                    ...
                    <div className="ms-5 col">
                        ...
                        <div className="row">
                            <h3>Deliverables</h3>
                            <span><a className="btn btn-outline-secondary button" href="https://www.figma.com/proto/Rdwja8WQicq4nvun7Em7og/Persuasive-Design--balance?page-%5b&hellip;%5d48%2C0.08&amp;scaling=scale-down&amp;starting-point-node-id=136%3A1150">High Fidelity Prototype</a></span>
                        </div>
                    </div>
                </div>
            </div>
