        ...
        <div>
                ...
                <div className='row'>
                    <div className="col br">
                        <h3 className='highlight'>
                            <mark>I researched ways to help college students find the balance between work and play.</mark>
                        </h3>

                        <br/><br/>

                        <p className='lead'>Most of our lives depend on our ability to do our work. While there is a wealth of research on work, there is no universal work strategy, and by extension, there is no universal method of taking breaks. Our project is meant to help people better their productivity and mental health by encouraging them to take a healthy amount of breaks. The end result is Balance, a social mobile app that encourages students to nominate their friends for fun mini-challenges and dares that they can participate in during their break times. This app utilizes the persuasive techniques of self-affirmation and social proof.</p>
                    ...
                    <div className="ms-5 col">
                        ...
                        <div className="row">
                            <h3>Methods</h3>
                            <p>Semi-Structured Interviews, Focus Groups, Literature Review, Remote Research, Usability Testing, Prototyping, Figma</p>
                        </div>
                        <br/>
                        <div className="row">
                            <h3>Deliverables</h3>
                            <span>
                                <a className="btn btn-outline-secondary button" href="https://www.figma.com/proto/Rdwja8WQicq4nvun7Em7og/Persuasive-Design--balance?page-%5b&hellip;%5d48%2C0.08&amp;scaling=scale-down&amp;starting-point-node-id=136%3A1150">High Fidelity Prototype</a>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div className="persuasive-problem white">
                ...
                <div className='px-5'>
                    ...
                    <h3 className="problem-b white display-5 font-weight-bold">
                        <strong>
                            People fail to give themselves breaks from work, which results in a lack of physical and mental self-care.
                        </strong>
                    </h3>
            ...
            <div className="px-5">
                ...
                <div>
                    ...
                    <br/>
                    <h3 className='highlight'>
                        <mark>How might we encourage people to have a healthier relationship with their work?</mark>
                    </h3>
                </div>
                <br/>
                <br/><br/>
            ...
            <div className="px-5">
                <div className="col-sm-6">
                    <strong>
                        <h3 className='big_intro font-weight-bold'>FOCUS GROUP + USER INTERVIEWS</h3>
                    </strong>
                    <br/>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col align-middle align-self-center pe-5">
                            <span>
                                <p className="pe-5 lead">An example of metaphors one participant associated with refreshing the mind</p>
                            </span>
                        </div>
                    </div>
                    <br/>
            ...
            <div className='px-5'>
                <div className="col-sm-7">
                    <strong>
                        <h3 className='big_intro font-weight-bold'>LITERATURE REVIEW  +  EXPERT CONSULTS</h3>
                    </strong>
                    <br/>
            ...
            <div className="px-5">
                <div className="col-sm-6">
                    <strong>
                        <h3 className='big_intro font-weight-bold'>PARALLEL PROTOTYPING</h3>
                    </strong>
                    <br/>
                    <div className='underline'>
                        <h3 className='highlight'>Which flow best enables break-taking among users?</h3>
                    </div>
                ...
                <div className="container ">
                    ...
                    <div className="row">
                        ...
                        <div className="col align-self-center">
                            <span>
                                <p className="lead">Select prototypes during the initial prototyping stage</p>
                            </span>
                        </div>
                    </div>
                    <br/>
            ...
            <div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col align-middle align-self-center">
                            <p className="lead">Self-affirmation does not simply involve sending explicity positive messages, and social proof needs to be implemented in a non-ardous and more implicit manner.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="px-5">
                        <strong>
                            <h3 className='big_intro font-weight-bold'>IDEAS</h3>
                        </strong>
                    </div>
                    <br/><br/><br/>
                    <div className="container">
            ...
            <div className="px-5">
                <div className="col-sm-6">
                    <strong>
                        <h3 className='big_intro font-weight-bold'>USABILITY TESTING</h3>
                    </strong>
                    <br/>
                    <div className='underline'>
                        <h3 className='highlight'>How can we ensure an enjoyable break-taking experience?</h3>
                    </div>

                </div>
                <br/><br/>
                <p className="lead">Our app built upon the initial ideas by focusing more on understanding user values as well as fun and efficient ways of taking breaks. Below are select screens from the next iteration of design ideas.
                </p>
                ...
                <div className="container ">
                    ...
                    <div className="row">
                        ...
                        <div className="col align-self-center">
                            <span>
                                <p className="lead">Select screens showing values, work session setup, and challenges</p>
                            </span>
                        </div>
                    </div>
                    <br/>
            ...
            <div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col align-middle align-self-center">
                            <p className="lead">People with busy work days will want to adjust breaks according to their schedule rather than stick to a Pomodoro every time.
                            </p>
                        </div>
                    </div>
                    <br/><br/>
                ...
                <div>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col align-middle align-self-center">
                                <p className="lead">Integrate Google Calendar to help manage busy schedules and suggest break times.
                                </p>
                            </div>
                        </div>
                        <br/><br/>
            ...
            <div className='bgGrey'>
                ...
                <div className="px-5">
                    <strong>
                        <h3 className="big_intro font-weight-bold">FINAL SOLUTION</h3>
                    </strong>
                    <br/>
            ...
            <div>
                <div className="px-5">
                    <strong>
                        <h3 className='big_intro font-weight-bold'>HOW BALANCE WORKS</h3>
                    </strong>
                    <br/><br/>
                    <div className='underline'>
                        <h3 className='highlight'>Setting Up for a Personalized Experience</h3>
                    </div>
                    <br/><br/>
                    <p className='lead col-sm-7'>Users start off by inputting their values and interests and providing calendar access to ensure recommended break times.
                    </p>
                    <div>
                ...
                <div className="px-5">
                    <div className='underline'>
                        <h3 className='highlight'>Create Work and Break Sessions.</h3>
                    </div>
                    <br/><br/>
                    <p className='lead col-sm-7'>Work and break sessions, along with the number of sessions can be set up according to the user’s schedule and preference through a Pomodoro style.
                    </p>
                    <div>
                ...
                <div className="px-5">
                    <div className='underline'>
                        <h3 className='highlight'>Have a Fun and Quick Break.</h3>
                    </div>
                    <br/><br/>
                    <p className='lead col-sm-7'>During the break, users can create, view, and respond to dares from their friends that were sent to them during their work session.
                    </p>
                    <div>
