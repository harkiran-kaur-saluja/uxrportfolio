...
complex problems and eager to learn and grow. I love playing word games and making dad jokes.</h4>
                ...
                <div className="col">
                    ...
                    <div className='container'>
                        <div className='row'>
                            <h4><strong className='bolded-words'>Experience</strong></h4>
                        </div>
                        <div className='row'>
                            <p>
                                <strong>Graduate Research Assistant </strong>/ Carnegie Mellon Social AI Group 
                                <ul>
                        ...
                        <div className='row'>
                            <p>
                                <strong>User Researcher </strong>/ Young Adult Survivors United 
                                <ul>
...
and enhance member engagement as well as cancer survivor experiences
                        ...
                        <div className='row'>
                            <p>
                                <strong>Design Researcher </strong>/ CTRL + F Lab
                                <ul>
...
inform research methods for children.
                        ...
                        <hr/>
                        <div className='row'>
                            <h4><strong className='bolded-words'>Education</strong></h4>
                        </div>
                        <div className='row'>
                            <p>
                                <strong>Master of Human Computer Interaction </strong>
                                <ul>
                        ...
                        <div className='row'>
                            <p>
                                <strong>Bachelor of Science in Informatics</strong><i>, cum laude, Phi Beta Kappa</i> 
                                <ul>
                        ...
                        <hr/>
                        <div className='row'>
                            <h4><strong className='bolded-words'>Awards</strong></h4>
                        </div>
                        <div className='row'>
                            <p>Faculty Award for Student Excellence in Informatics</p>
                        </div>
                        <div className='row'>
                            <p>CHI 2021 Best Paper Award </p>
                        </div>
                    </div>
                ...
                <div className="col">
                    {/*skills, publications*/}
                    <div className='row'>
                        <h4><strong className='bolded-words'>Skills</strong></h4>
                    </div>
                    <div className='row'>
                        <h5><strong>UX Methods</strong> </h5>
                        <p>
                            In-Depth Interviews
                            <br/>
                            Survey Design
                    ...
                    <hr/>
                    <div className='row'>
                        <h4><strong className='bolded-words'>Publications</strong></h4>
                    </div>
                    <div className='row'>
                        <p>
